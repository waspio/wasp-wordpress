...
global $wasp_levels, $wasp, $wasp_activated, $wasp_default_ignored, $wasp_capable;
...
$wasp_capable = true;
//Perform a single check to determine if Wasp may be used
...
function register_wasp_settings()
{
    ...
    register_setting( 'wasp-settings-group', 'wasp_filters' );
}
...
if( !function_exists( 'wasp_start' ) )
{
    function wasp_start()
    {
        ...
        if( 
            ...
            wasp_checkkey() && 
            ( get_option( 'wasp_active_status' ) == 1 ) && 
            $wasp_capable === true
        )
        {
            ...
            $filters = get_option( 'wasp_filters' );
            if( !empty( $filters ) )
            {
...
if( !function_exists( 'wasp_track_404' ) )
{
    ...
    {
        global $wasp_activated, $wasp_capable;
        //Add the 404 handler function as needed
        if( $wasp_capable === true && $wasp_activated && is_404() && get_option( 'wasp_track_404' ) == 1 )
        {
            global $wasp;
